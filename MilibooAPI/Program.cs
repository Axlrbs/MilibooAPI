...
builder.Services.AddCors(options =>
{
    ...
    {
        policy.WithOrigins("http://localhost:5173", "http://localhost:8950", "http://localhost:8978", "http://localhost:8948", "http://localhost:8951", "http://51.83.36.122:8948", "http://51.83.36.122:8953", "http://51.83.36.122:8952")
              .AllowAnyHeader()
              .AllowAnyMethod()
              .AllowCredentials(); 
    });
